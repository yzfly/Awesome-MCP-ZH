...
| [rasterly-dev/rasterly-mcp](https://github.com/rasterly-dev/rasterly-mcp) | MCP 原生网页 API：把任意 URL 转为干净 Markdown、截图、PDF、结构化 JSON，或整站抓取。Firecrawl 的低价替代，提取功能内置，$0.90/1k。安装：`npx -y rasterly-mcp`。 | 社区实现, TypeScript 开发 📇, 云端服务 ☁️, 低价 Firecrawl 替代。 |
