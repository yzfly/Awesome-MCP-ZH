...
| [Equibles](https://github.com/daniel3303/stock-market-mcp-server) | 美股市场数据 MCP 服务器：实时股票与期权价格、美国国会议员交易、内部人交易、SEC 文件全文检索、XBRL 基本面数据、13F 机构持仓、财报电话会议记录、做空数据及 FRED 宏观经济数据，共 90+ 个工具。 | 官方实现 🎖️, 云服务 ☁️, 免费套餐，远程服务器 `https://mcp.equibles.com/mcp`，亦可自托管。 |
