...
| [Bounty Radar](https://github.com/go165/bounty-radar) | 搜索和筛选带有赏金、USDC、Base、x402、MRWK 等付费线索的 GitHub Issues，帮助开发者和编码代理优先评估值得投入的开源任务。 | 社区实现, JavaScript 开发 📇, 本地运行 🏠, 静态页面 + JSON/CSV Feed + MCP stdio 工具。 |
