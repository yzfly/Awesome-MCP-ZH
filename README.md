...
| [AMEOBIUS/mcp-secrets-tools](https://github.com/AMEOBIUS/mcp-secrets-tools) | MCP 服务器，用于密钥生成。12 个工具：安全密码、令牌、API 密钥、OTP、口令、SHA-256 哈希、HMAC、盐值、熵计算。零依赖，纯 Python 标准库。 |
