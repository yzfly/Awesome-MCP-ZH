...
| [SqueezeOS](https://github.com/Timwal78/SqueezeOS) | 机构级交易 MCP 服务器，33 个工具。Schwab/Polygon/Alpaca API，x402 支付门控（XRPL/RLUSD + Base/USDC），短压轧检测，FTD 周期分析。免费版 + 付费信号层。远程: squeezeos-api.onrender.com/mcp | TypeScript 开发 📇, 云服务 ☁️, x402 支付, XRPL/RLUSD, 机构交易。 |
| [xDEO 收益预言机](https://xdeo.timothy-walton45.workers.dev) | 去中心化收益预言机。\/bin/sh.01/次调用 vs Bloomberg k/年。SEC EDGAR 验证，AI 分析报告 \/bin/sh.75。x402 原生 MCP 服务器。 | TypeScript 开发 📇, 云服务 ☁️, x402 支付, SEC EDGAR, 收益分析。 |
| [Ghost Layer](https://ghost-layer.onrender.com) | 自主 AI 智能体双链 XRPL/Base 收费网关。URIToken 链上授权，54 块执行矩阵，Agent Passport 忠诚度等级，x402 协议，零托管。MCP: ghost-layer.onrender.com/mcp | TypeScript/Go 开发 📇, 云服务 ☁️, XRPL, Base, x402, 零托管。 |
| [proof402-middleware](https://www.npmjs.com/package/@relayos/mcp-paywall) | MCP 服务器的 HTTP 402 付费墙中间件。XRPL/RLUSD + Base/USDC 原生结算，零 API 密钥。npm: @relayos/mcp-paywall | TypeScript 开发 📇, npm 包, XRPL/RLUSD, x402, 即插即用。 |
