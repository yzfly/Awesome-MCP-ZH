...
| [defi-mcp](https://github.com/OzorOwn/defi-mcp)                                      | DeFi 与加密货币 MCP 服务器，支持代币价格查询、多链钱包余额、Gas 费用估算、DEX 报价（Jupiter/Uniswap）和代币元数据，提供 12 个 MCP 工具。 | 社区实现, TypeScript 开发 📇, 云服务 ☁️, 本地运行 🏠, DeFi 多链代币价格/钱包/DEX。                            |
