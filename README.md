...
| [Lamdis Exchange](https://github.com/lamdis-ai/lamdis-protocol) | 让 AI 代理付钱给附近的人，去现实世界中核实某件事或办某件事，以照片作为证明；提供免费沙盒，无需账号。 | 官方实现 (Lamdis) 🎖️, Go 开发 🏎️, 云服务 ☁️, 远程 Streamable HTTP `https://exchange.lamdis.ai/mcp`，8 个访客工具无需认证，可选 `Authorization: Bearer lam_sk_...` 代理密钥。 |
