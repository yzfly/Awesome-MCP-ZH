...
| [Alibaba Cloud DashScope](https://github.com/hzy9981/vertex-ai-mcp-bridge) | 阿里云百炼 (DashScope) MCP 集成，支持通过代理调用百炼平台上的联网搜索、插件工具及大模型能力。 | 社区实现, Python 开发 🐍, 支持跨云代理与 SSE 部署。 |
