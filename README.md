...
| [ContextWire](https://github.com/keptlive/contextwire-mcp) | 免费 AI 代理搜索 API，105 个搜索引擎，22 种搜索配置，94.3% SimpleQA 准确率。包含 MCP 服务器。 | 社区实现, TypeScript 开发 📇, 云服务 ☁️, AI 代理专用搜索 API。 |
