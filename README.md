...
| [runapi-ai/mcp](https://github.com/runapi-ai/mcp) | RunAPI MCP Server — 130+ AI 模型聚合 MCP Server，覆盖图像、视频、音乐、音频、LLM 五大模态，18 个供应商。免费目录浏览，`npx @runapi.ai/mcp` 即可在 Claude Code、Cursor、Codex 中使用。 | 社区实现, TypeScript 开发 📇, 云服务 ☁️, 多模态 AI 模型聚合 (RunAPI)。 |
