...
| [AMEOBIUS/mcp-color-tools](https://github.com/AMEOBIUS/mcp-color-tools) | MCP 服务器，用于颜色操作。19 个工具：解析（hex/rgb/hsl）、转换、操作（变亮/变暗/饱和/互补/反转/灰度）、调色板（类比/三色/渐变）、WCAG 对比度、混合。零依赖，纯 Python 标准库。 |
