...
| [LLM Pulse](https://github.com/LLM-Pulse/llmpulse-mcp) | 面向 AI 搜索可见性分析的官方 MCP 服务，可查询品牌提及、引用来源、情感、竞品声量份额和 GEO 表现。 | 官方实现 (LLM Pulse) 🎖️, JavaScript 开发 📇, 云端/本地 🏠☁️, Streamable HTTP + stdio, 需 Scale 或更高方案的 API Key。 |
