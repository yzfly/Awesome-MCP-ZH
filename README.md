...
| [RustChain MCP](https://github.com/Scottcjn/rustchain-mcp) | RustChain 区块链和 BoTTube 视频平台的 MCP 服务器。提供 15 个工具，用于挖矿认证、钱包管理、赏金猎取和视频发布。通过古董硬件证明 (Proof-of-Antiquity) 共识机制赚取 RTC 代币。 | 社区实现, Python 开发, 区块链与视频平台, `pip install rustchain-mcp` |
