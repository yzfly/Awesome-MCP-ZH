...
| [ProposalCraft](https://github.com/jabbawocky/proposalcraft)               | 根据你过去的成功提案，自动生成客户提案草稿。分析需求文档中的预算信号和潜在风险，一键生成符合你写作风格的提案。无需 API Key，完全本地运行。 | 社区实现, TypeScript 开发 📇, 本地运行 🏠, 自由职业者提案生成工具。                                    |
