...
| [AMEOBIUS/mcp-diff-tools](https://github.com/AMEOBIUS/mcp-diff-tools) | MCP 服务器，用于差异操作。14 个工具：统一/上下文/HTML 差异、行/词差异、相似度、文件/目录差异、补丁生成与应用、合并冲突检测、差异统计。零依赖，纯 Python 标准库。 |
