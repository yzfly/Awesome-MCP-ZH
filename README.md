...
| [AMEOBIUS/mcp-uuid-tools](https://github.com/AMEOBIUS/mcp-uuid-tools) | MCP 服务器，用于 UUID 操作。16 个工具：生成 v1/v3/v4/v5、验证、解析、批量生成、比较、十六进制转换、nil UUID、短 UUID。零依赖，纯 Python 标准库。 |
