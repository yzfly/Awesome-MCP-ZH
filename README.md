...
| [SafeAgent Token Safety](https://github.com/Aigen-Protocol/aigen-protocol)         | 实时代币安全分析MCP服务器。支持6条EVM链，检测27种骗局模式，包括蜜罐检测、隐藏铸造和所有权漏洞。38个MCP工具可用。 | 社区实现, TypeScript 开发 📇, 云服务 ☁️, 多链代币安全分析。                                          |
