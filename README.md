...
| [longbridge/longbridge-mcp](https://github.com/longbridge/longbridge-mcp)          | 长桥证券官方 MCP 服务，133 个工具覆盖港美股实时行情、期权、交易、基本面、IPO、价格提醒、定投与组合分析。 | 官方实现 (Longbridge) 🎖️, Rust 开发 🦀, 云服务 ☁️, OAuth 2.1 认证, 港美 A 股全市场覆盖。               |
