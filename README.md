...
| [Are you found by AI?](https://github.com/techhorizonlabs/foundbyai-mcp) | AI 可见度测量 MCP 服务器：面向 7 大 AI 答案引擎（ChatGPT、Claude、Gemini、Perplexity、Grok、DeepSeek、Google AI Overviews）实测企业是否被 AI 推荐，提供可见度与就绪度评分及趋势、逐问题历史、AI 转而推荐的竞品、声量份额、引用来源、优先级修复清单、AI 引流访客，以及受限的重新测量操作。 | 官方实现 🎖️, 远程 MCP 服务器 ☁️, 演示端点无需账号: `https://areyoufoundbyai.com/mcp/demo` |
