...
| [AMEOBIUS/mcp-random-tools](https://github.com/AMEOBIUS/mcp-random-tools) | MCP 服务器，用于随机生成。17 个工具：UUID、安全密码、随机数、颜色、lorem ipsum、骰子、假名/邮箱、随机字符串、掷硬币。零依赖，纯 Python 标准库。 |
