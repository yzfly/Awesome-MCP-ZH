...
| [SkillBoss](https://github.com/heeyo-life/skillboss-mcp)                          | 一个 API Key 访问 100+ AI 服务：Claude/GPT/Gemini/DeepSeek 等 50+ 模型、图像/视频生成、数据采集、支付、邮件等。OpenAI 兼容，支持 Claude Code/Cursor/Windsurf。 | 官方实现 (SkillBoss) 🎖️, TypeScript 开发 📇, 云服务 ☁️, 跨平台 🍎🪟🐧, AI 服务统一网关。           |
