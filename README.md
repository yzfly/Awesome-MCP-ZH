...
| [KLinePic MCP Server](https://github.com/sher1096/klinepic-agent-api-examples) | 将券商或交易所成交记录生成带买卖点、盈亏和说明的 K 线复盘图，提供能力查询、免费预检及单图/批量渲染，不提供交易信号或下单。 | 官方实现 (KLinePic) 🎖️, JavaScript 开发 📇, 本地运行 🏠, 跨平台 🍎🪟🐧, 3 个工具，支持 GitHub `npx` 与 Docker。 |
