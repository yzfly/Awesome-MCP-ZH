...
| [SandBase CLI](https://github.com/sandbaseai/cli) | 本地优先的 MCP 桥接 CLI，将 Codex、Claude Code、Cursor、Windsurf、Gemini CLI、OpenCode 等客户端连接到统一的 SandBase 模型与 API 目录；支持 OAuth、版本回滚和发布校验。 | 社区实现, TypeScript 开发 📇, 本地运行 🏠, MCP 客户端桥接, Apache-2.0。 |
