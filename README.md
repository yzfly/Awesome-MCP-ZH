...
| [Sharpe MCP Server](https://www.sharpe.ai/docs/mcp-server)                       | 连接 AI 代理与 Sharpe Terminal 的加密货币衍生品和市场情报数据，覆盖资金费率、期货、期权、套利、叙事、交易所上新、新闻和代币风险检查。 | 官方文档, Python 包 🐍, 云服务 ☁️, 加密货币衍生品与市场数据；安装：`uvx sharpe-mcp`。                 |
