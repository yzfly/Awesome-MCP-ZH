...
| [BeLikeNative Grammar Server](https://github.com/theluckystrike/bln-mcp-grammar-server) | 基于母语感知的语法、拼写和文体检查 MCP 服务器，内置 70 条本地规则。支持 Docker 部署，无需 API 密钥。 | 社区实现, TypeScript 开发 📇, 本地运行 🏠, 语法检查/写作辅助。 |
