...
| [TokRepo](https://github.com/henu-wang/tokrepo-mcp-server)                         | 面向 AI Agent 的开放资产注册表 MCP 服务器，可搜索和安装 220+ 个 Skills、Prompts、MCP Configs 与 Workflows。 | 社区实现, TypeScript 开发 📇, 本地/云端 🏠☁️, AI 资产发现与安装。                                      |
