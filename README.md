...
| [AMEOBIUS/mcp-hash-tools](https://github.com/AMEOBIUS/mcp-hash-tools) | MCP 服务器，用于哈希操作。11 个工具：MD5、SHA1、SHA256、SHA512、CRC32、HMAC、文件哈希、批量哈希、加盐哈希。零依赖，纯 Python 标准库。 |
