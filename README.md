...
| [Rafter](https://heyrafter.xyz) | 团队共享记忆、技能与 Agent 的托管远程 MCP：Claude、Cursor 等客户端每次会话自动携带团队上下文；支持全文+实体搜索、带引用图谱的 fetch、add_memory 与版本化技能/Agent 工件。 | 官方实现 (Rafter) 🎖️, 远程端点 ☁️ `https://app.heyrafter.xyz/api/mcp`, OAuth 2.1 授权。 |
