...
| [Chart Library](https://github.com/grahammccain/chart-library-mcp)                   | 历史图表模式搜索引擎，提供19个MCP工具。从24M+预计算嵌入中查找相似的股票图表模式，涵盖15K+股票和10年数据。 | 社区实现, Python 开发 🐍, 云服务 ☁️, PyPI: `chartlibrary-mcp`, 股票图表模式搜索。                         |
