...
| [HCS412/ventureautomated](https://github.com/HCS412/ventureautomated)               | 面向 VC、天使和家办的创业公司发现、公司评分、投研备忘录与市场监控 MCP 服务，支持远程 MCP 与企业私有工作区自动化。 | 官方实现 (Omnis/BambooSnow) 🎖️, TypeScript 开发 📇, 云服务 ☁️, 适合投资研究、机会筛选与持续监控。       |
