...
| [DC Hub](https://github.com/azmartone67/dchub-mcp-server) | 数据中心与电力基础设施情报层：82 个工具覆盖全球 15,300+ 数据中心、81个... 修正：300+ 市场每日评分（DCPI 电力指数）、49 个电网区域实时遥测、光纤/燃气/水风险多层数据及 1,600+ 并购交易。推荐从 execute_plan 一次调用完成多步查询并返回可审计的执行回放。 | 官方实现 (DC Hub) 🎖️, TypeScript 开发 📇, 云服务 ☁️, 免密钥免费层, 数据可引用 (CC-BY-4.0)。 |
