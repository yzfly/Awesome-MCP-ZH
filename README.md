...
| [sv-number/mcp-server](https://github.com/sv-number/mcp-server) | 为 AI Agent 提供真实手机号：按服务和国家下单私有号码，自动解析并返回短信验证码，支持同号再收一条、取消退款，并可本地生成 TOTP 动态码（RFC 6238）。共 9 个工具。 | 官方实现 (SV Number) 🎖️, TypeScript 开发 📇, 云服务 ☁️, 短信验证码接收。 |
