...
| [155143783/mcp-data-api](https://github.com/155143783/mcp-data-api) | 多源数据聚合 MCP 服务器，提供16个工具访问加密货币、新闻、天气、金融、地理等数据，支持 x402 微支付协议。 | 社区实现, TypeScript 开发 📇, 云服务 ☁️, 多源数据聚合, x402 微支付。 |
