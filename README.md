...
| [AMEOBIUS/mcp-search-tools](https://github.com/AMEOBIUS/mcp-search-tools) | MCP 服务器，用于文本搜索。11 个工具：文本搜索、行搜索、模糊匹配、正则搜索、高亮、搜索替换、TF 排名、多查询搜索、模式提取（邮箱/URL/IP/电话/日期/标签）、词频分析、自动补全。零依赖，纯 Python 标准库。 |
