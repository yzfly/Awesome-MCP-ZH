...
| [Unified AI System](https://github.com/happy520ai/unified-ai-system)            | 终端优先的自托管 AI 网关及 MCP Server，通过 8 个 MCP 工具向 Codex 等客户端提供聊天、健康检查、知识、工作流和 Agent 能力。 | 社区实现, TypeScript 开发 📇, 本地运行 🏠, Docker 🐳, 默认使用无需 API Key 的本地模拟提供商。 |
