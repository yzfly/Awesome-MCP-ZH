...
| [AI Dev Jobs](https://aidevboard.com)                                  | AI/ML 职位搜索 MCP 服务器，索引 6,100+ 个 AI 职位，321 家公司。提供 `search_jobs`、`get_job`、`list_companies`、`get_stats` 工具。`claude mcp add --transport http aidevjobs https://aidevboard.com/mcp` | 社区实现, Go 开发 🏎️, 云服务 ☁️, AI 职位搜索。                                            |
