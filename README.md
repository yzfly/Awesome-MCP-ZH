...
| [OBSD LaunchPad](https://github.com/thryxagi/obsd-launchpad)                        | Base 链上 AI 代理全生命周期代币 MCP。12 个工具：部署代币、买入、卖出、领取费用、报价、推荐计划、收益分析。通过 `npx obsd-launchpad-mcp` 安装。国库支持的内在价值底价，37.5% 被动 OBSD 收入。 | 社区实现, TypeScript 开发 📇, 云服务 ☁️, Base 链代币部署与交易。                                        |
