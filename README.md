...
| [AMEOBIUS/mcp-collection-tools](https://github.com/AMEOBIUS/mcp-collection-tools) | MCP 服务器，用于列表操作。19 个工具：去重、交集、并集、差集、对称差集、扁平化、分块、排序、分组、计数、旋转、采样、分区、压缩、反转、查找、包含、头部、尾部。零依赖，纯 Python 标准库。 |
