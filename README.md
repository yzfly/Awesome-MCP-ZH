...
| [AMEOBIUS/mcp-conversion-tools](https://github.com/AMEOBIUS/mcp-conversion-tools) | MCP 服务器，用于单位转换。6 个工具、13 个类别（长度、重量、温度、数据、速度、面积、体积、时间、压力、能量、角度、频率、燃油）。零依赖，纯 Python 标准库。 |
