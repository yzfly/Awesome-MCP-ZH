...
| [AMEOBIUS/opendaw-mcp](https://github.com/AMEOBIUS/opendaw-mcp) | 263 个 MCP 工具，让 AI 代理控制浏览器端 DAW (openDAW) — 合成器、效果器、MIDI、混音、自动化、渲染、stem 分离、自定义 DSP 脚本。支持 LangChain/AutoGen 集成。 | 社区实现, Python 开发 🐍, 本地运行 🏠, 音乐制作 DAW 自动化, 263 工具, `pip install opendaw-mcp`。 |
