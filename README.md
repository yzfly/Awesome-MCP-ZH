...
| [AnveVoice](https://anvevoice.app) | 网站语音AI助手，支持MCP协议、自主DOM操作、50+种语言、<700ms延迟。免费版可用 / Voice AI agent for websites with MCP support, agentic DOM actions, 50+ languages, <700ms latency. Free tier. | 商业产品 💼, 云服务 ☁️, 网站语音助手/DOM 操作。 |
