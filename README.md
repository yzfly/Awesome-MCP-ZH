...
| [AMEOBIUS/mcp-stats-tools](https://github.com/AMEOBIUS/mcp-stats-tools) | MCP 服务器，用于统计分析。19 个工具：均值、中位数、众数、标准差、方差、百分位、四分位、相关系数、线性回归、偏度、峰度、Z 分数。零依赖，纯 Python 标准库。 |
