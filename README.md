...
| [axiosdevs/agentscoin-mcp](https://github.com/axiosdevs/agentscoin-mcp) | 给 AI Agent 一个自己的链上钱包：创建钱包、收发、交易代币，含命名服务与按次计费数据 API 的 MCP 服务器。 | 社区实现, TypeScript 开发 📇, 云服务 ☁️, 智能体支付 / x402。 |
