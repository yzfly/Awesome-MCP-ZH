...
| [Neither](https://github.com/stonianua/neither-mcp) | 面向 Cursor 与 Claude Desktop 的本地 stdio MCP：选中笔记/文档，关联检索并附带来源证据。 | 社区实现, TypeScript 开发 📇, 本地运行 🏠, `npx -y @neitherai/mcp-server`, 需 NEITHER_API_KEY。 |
