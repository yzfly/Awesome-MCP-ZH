...
| [SandBase CLI](https://github.com/sandbaseai/cli) | 开源 TypeScript CLI 与本地 MCP 网关，将 ChatGPT、Claude Code、Cursor、Codex 等客户端连接到 2,000+ AI 模型和 API。 | 社区实现, TypeScript 开发 📇, 本地运行 🏠, 跨客户端模型路由与 MCP 工具聚合, Apache-2.0。 |
