...
| [AgentPay](https://github.com/ronaldanton/x402-shop)                    | AgentPay：22 个按调用付费（x402）的 AI 微服务，含远程 MCP 服务器 — 摘要、保险线索分析、代码审查、代币安全检查等，$0.01–$0.10 USDC/次（Base 链），无需 API 密钥，代理按调用付费。 | 官方实现 🎖️, 云服务 ☁️, 远程服务器 `https://agentpay.help/mcp`，x402 USDC 微支付，无需 API 密钥。 |
