...
| [AgentSeal](https://github.com/JoeyBrar/agentseal-mcp)                           | AI Agent 可验证行为日志。使用 SHA-256 哈希链记录每一个操作，提供可验证审计追踪。通过 `npx agentseal-mcp` 安装。 | 社区实现, TypeScript 开发 📇, 本地运行 🏠, MCP Server (stdio), Agent 行为审计。 |
