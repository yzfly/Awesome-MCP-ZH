...
| [MCP Doctor](https://github.com/xlyoung/mcp-doctor) | MCP Server 安全扫描与质量评分工具。10 项安全检测引擎、0-100 质量评分、100+ 预评分 Server 注册表、一键安装。CLI 工具，支持 CI/CD 集成。 | 社区实现, Python 开发 🐍, 本地运行 🏠, MCP 安全扫描 + 质量评分 + 注册表。 |
