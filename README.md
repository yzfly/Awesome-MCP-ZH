...
| [connerlambden/helium-mcp](https://github.com/connerlambden/helium-mcp) | 免费的远程 MCP + REST 服务器，提供基于机器学习的期权定价（公允价值、ITM 概率、希腊字母）和结构化新闻智能（320 万+ 文章，31 维偏见评分）。 | 社区实现, 远程服务 ☁️, 期权 ML 定价 + 新闻偏见分析, 每 IP 免费 50 次查询。 |
