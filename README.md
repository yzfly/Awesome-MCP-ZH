...
| [AMEOBIUS/mcp-crypto-monitor](https://github.com/AMEOBIUS/mcp-crypto-monitor) | MCP 服务器，用于加密货币钱包和价格监控。10 个工具：BTC/ETH/ERC20 余额查询、CoinGecko/Binance 价格、投资组合价值计算、ETH Gas 跟踪器、恐惧贪婪指数。零依赖，仅使用免费 API，无需 API 密钥。 |
