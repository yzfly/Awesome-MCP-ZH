...
| [Autoposting](https://github.com/Autoposting-ai/autoposting-mcp) | 远程 MCP 服务器，让 AI 客户端起草、改写、定时和发布社交内容到 X、LinkedIn、Instagram、Threads 和 YouTube，并支持 AI 选题生成、轮播图制作、视频剪辑与知识库检索。 | 官方实现 (Autoposting) 🎖️, 云服务 ☁️, Streamable HTTP, OAuth 2.1 动态客户端注册 (无需配置密钥), 69 个工具, 端点 `https://app.autoposting.ai/mcp`。 |
