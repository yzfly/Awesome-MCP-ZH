...
| [Aperture Wallet Knowledge](https://github.com/devdasx/aperture) | Aperture 钱包官方只读知识 MCP 服务器，供 AI 搜索并引用产品事实、自托管安全模型、25 条生产主网、已发布功能、App Store 版本、界面语义和完整 Journal 文章；不连接钱包，也不能读取余额、凭据、签名或发起交易。 | 官方实现 (Aperture) 🎖️, 云服务 ☁️, Streamable HTTP, 12 个只读工具, 无需认证, 远程服务器 `https://aperturex.io/mcp/`, 官方 Registry ID `io.aperturex/aperture-wallet-knowledge`。 |
