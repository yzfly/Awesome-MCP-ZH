...
| 名称                                                                               | 中文介绍                                                                                                | 备注                                                                                                         |
| :--------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------ | :----------------------------------------------------------------------------------------------------------- |
| [alex-jinhui/chinafin-mcp](https://github.com/alex-jinhui/chinafin-mcp)                    | 中国 A 股/港股金融数据 MCP 服务器 — 实时行情、K线图、财务报表、大盘概览、热门板块。6 个工具，基于 AKShare。                                                              | 社区实现, Python 开发 🐍, 云端/本地 ☁️🏠, 中国金融数据 (A股/港股)。                                      |
