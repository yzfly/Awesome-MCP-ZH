...
| [DepthFeed](https://github.com/vcorp-dev/depthfeed-mcp) | 获取 Polymarket、Kalshi 和 Limitless 的实时与历史预测市场订单簿，支持市场搜索、深度快照和跨平台筛选。 | 官方实现 (DepthFeed) 🎖️, 云服务 ☁️, 远程 Streamable HTTP，免费无密钥试用，12 个只读工具。 |
