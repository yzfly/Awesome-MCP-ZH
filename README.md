...
| [ParlayAPI](https://github.com/JacobiusMakes/parlay-api-mcp) | 查询体育赛事赔率、球员专项盘口、公开赛事信息与个人账户用量；账户数据工具使用用户自己的 API Key，并受账户额度限制。 | Python 开发 🐍, 本地 stdio 连接云端 API, 软件采用 MIT, `uvx --from parlayapi-mcp==0.3.5 parlayapi-mcp`。 |
