...
| [sandbaseai/cli](https://github.com/sandbaseai/cli) | SandBase CLI 将 Claude Desktop、Cursor、Codex、Claude Code 等 AI 客户端连接到 2,000+ AI 模型与 API 工具；通过本地 MCP 桥接器统一配置、发现和调用。 | 官方实现 (SandBase) 🎖️, TypeScript 开发 📇, 本地运行 🏠, Apache-2.0, `npx -y @sandbaseai/cli@0.1.14 connect --client claude-desktop`。 |
