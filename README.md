...
| [kevinastuhuaman/trackly-cli](https://github.com/kevinastuhuaman/trackly-cli) | AI 求职 MCP 服务器 — 128K+ 实时职位，1,900+ 公司。10 个工具：搜索职位、跟踪申请、查找联系人、发起内推。支持远程 OAuth (`https://mcp.usetrackly.app/api/mcp`) 或本地 stdio (`npx trackly-cli mcp`)。 | 社区实现, JavaScript/Node 开发 📇, 云端/本地 ☁️🏠, 求职与内推。                          |
