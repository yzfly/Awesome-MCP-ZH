...
| [shopsavvy/shopsavvy-mcp-server](https://github.com/shopsavvy/shopsavvy-mcp-server) | 为 AI 助手提供实时商品价格、价格历史和购物工具，覆盖数万家零售商和上亿商品。免费使用，无需注册。 | 社区实现, TypeScript 开发 📇, 购物与电商 🛒。 |
