...
| [AgentPay](https://github.com/ronaldanton/x402-shop)                    | AgentPay：28 个按调用付费（x402）的 AI 微服务，含远程 MCP 服务器 — 网络搜索、钱包记忆、地理编码、预测市场、深度研究报告、摘要、保险分析、代币安全等，$0.003–$0.25 USDC/次（Base 链），无需 API 密钥，代理按调用付费。 | 官方实现 🎖️, 云服务 ☁️, 远程服务器 `https://agentpay.help/mcp`，x402 USDC 微支付，无需 API 密钥。 |
