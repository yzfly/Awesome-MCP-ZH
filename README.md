...
| [ToolRouter](https://toolrouter.com)                                              | 一站式AI工具网关，一个账户即可访问150+工具。竞争对手研究、视频制作、网络搜索、图像生成、安全扫描等，无需管理多个服务商账户。 | 社区实现, TypeScript 开发 📇, 云服务 ☁️, 150+ 工具聚合网关, npm: toolrouter-mcp。                     |
