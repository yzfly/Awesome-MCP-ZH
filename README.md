...
| [AMEOBIUS/mcp-math-tools](https://github.com/AMEOBIUS/mcp-math-tools) | MCP 服务器，用于数学操作。22 个工具：表达式求值、统计、单位转换（长度/重量/温度/数据）、数论（质数/因数/GCD/LCM/斐波那契/阶乘）、几何。零依赖，纯 Python 标准库。 |
