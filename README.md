...
| [AMEOBIUS/mcp-clipboard-manager](https://github.com/AMEOBIUS/mcp-clipboard-manager) | MCP 服务器，用于剪贴板和代码片段管理。18 个工具：复制/粘贴、命名片段存储、模板渲染、剪贴板历史、代码格式化。零依赖，纯 Python 标准库。 |
