...
| 名称                                                                               | 中文介绍                                                                                                         | 备注                                                                                                    |
| :--------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------ |
| [EGC](https://github.com/Fmarzochi/EGC) | 跨会话持久记忆 MCP 服务，支持 Claude Code、Cursor、Gemini CLI、Codex、Windsurf 等 13+ AI 编程工具，SQLite 本地存储，上下文重置后状态保持。`npm install -g @egchq/egc` | 社区实现, TypeScript 开发 📇, 本地运行 🏠, 跨工具状态同步。 |
