...
| [BuyWhere/buywhere-mcp](https://github.com/BuyWhere/buywhere-mcp) | 跨境电商产品搜索与比价 MCP 服务器，为 AI 代理提供新加坡、东南亚及美国市场的商品搜索、跨平台比价和历史价格查询功能。安装：`npx buywhere-mcp`。 | 社区实现 (BuyWhere), TypeScript 开发 📇, 云服务 ☁️, 跨市场产品搜索 🛒。 |
