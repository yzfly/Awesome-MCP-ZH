...
| [Frontier-Compute/zcash-mcp](https://github.com/Frontier-Compute/zcash-mcp)          | Zcash 隐私区块链 MCP 服务器，22 个工具：屏蔽发送、备忘录解码、ZAP1 证明、MPC 钱包、跨链交换。 | 社区实现, TypeScript 开发, 云服务 ☁️, Zcash 隐私交易。                                                  |
