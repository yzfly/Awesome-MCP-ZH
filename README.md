...
| [Aigen-Protocol/aigen-protocol](https://github.com/Aigen-Protocol/aigen-protocol)         | 开放式 AI 代理赏金协议 — 在 Base + Optimism 上发布任务,以 USDC/ETH/AIGEN 支付,代理完成工作,**0.5% 协议费** vs Replit/Bountybird/Superteam Earn 的 5-20%。内置代币安全扫描、NFT 扫描、预测市场、DAO 治理保险池。 | 开源 MIT, Python 开发 🐍, 云服务 ☁️, AIGEN 协议官方,代币:0xF6EFc5D5… (Optimism)。 |
...
| [Aigen-Protocol/aigen-protocol](https://github.com/Aigen-Protocol/aigen-protocol)         | **代币安全 + 开放赏金协议** — 在 Base/Optimism 上扫描代币安全 (蜜罐检测、源代码模式扫描) 并通过链上 USDC 支付的赏金市场协调代理工作。已在金融部分列出。 | 开源 MIT, Python 开发 🐍, 云服务 ☁️, AIGEN 协议官方。 |
