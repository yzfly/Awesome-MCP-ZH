...
| [AMEOBIUS/mcp-text-tools](https://github.com/AMEOBIUS/mcp-text-tools) | MCP 服务器，用于文本操作。28 个工具：正则表达式、编码（base64/URL/HTML/hex）、哈希、字符串变换（大小写/反转/截断/填充/换行）、文本分析（频率/slugify/diff）。零依赖，纯 Python 标准库。 |
