...
| [AMEOBIUS/mcp-process-manager](https://github.com/AMEOBIUS/mcp-process-manager) | MCP 服务器，用于进程管理。12 个工具：列出/启动/杀死进程、按名称杀死、等待进程、系统信息（CPU/内存/负载/运行时间/磁盘）、环境变量管理、查找命令。零依赖，纯 Python 标准库。 |
