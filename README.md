...
| 名称                                                                       | 中文介绍                                                                                                 | 备注                                                                                                          |
| :------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------ |
| [ProposalCraft](https://github.com/jabbawocky/proposalcraft)               | 用你的过往获奖提案风格起草客户提案的 MCP 服务器。粘贴客户简报，即可生成可直接发送的提案。包含 analyze_brief、draft_proposal 工具及 12 个行业模板。无需 API Key，完全本地运行。 | 社区实现, TypeScript 开发 📇, 本地运行 🏠, 自由职业提案生成。                                             |
