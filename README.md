...
| [GoldBean](https://github.com/wuzenghai616-lang/goldbean) | GoldBean x402 付费 API 市场，提供 120+ 付费端点（AI/区块链/DeFi/天气/搜索等），支持 x402 微支付（Base 链 USDC），以及支付宝/PayPal 付款。百度 AI 13 个 API 即插即用。 | 社区实现, Node.js 开发 📇, 云服务 ☁️, x402 微支付, 百度 AI 集成。 |
