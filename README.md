...
| [Stellary](https://github.com/Anymfah/stellary-mcp)                        | Stellary 官方远程 MCP：看板、文档、驾驶舱与受治理的 agent missions。Streamable HTTP + Bearer PAT。 | 官方实现 (Stellary) 🎖️, 云服务 ☁️, 远程端点 `https://api.stellary.co/mcp`, 官方 MCP Registry `io.github.Anymfah/stellary-project-management`。 |
