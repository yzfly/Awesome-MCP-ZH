...
| [Bilig WorkPaper](https://github.com/proompteng/bilig) | 面向 Node.js 服务和 Agent 工具的公式 WorkPaper MCP 服务器，支持修改单元格、重新计算、读回校验并持久化 JSON。 | 社区实现, TypeScript 开发 📇, 本地运行 🏠, 适合后端服务中的公式工作簿、报价/定价/校验流程和 agent 可审计表格状态。 |
