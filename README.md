...
| [BankBridge](https://github.com/bankbridge-money/bankbridge-plugin)               | 为 AI Agent 提供只读银行账户访问 - 余额、交易、订阅、月度现金流、商户历史、投资持仓查询，通过 Plaid 实时获取数据，无任何缓存。已发布到官方 MCP Registry: `money.bankbridge/server`。 | 官方实现 (Great Work LLC) 🎖️, TypeScript 开发 📇, 云服务 ☁️, 12 个只读工具，$5/月每家银行，支持 Bearer / OAuth 2.1。 |
