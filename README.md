...
| [Animica](https://github.com/animicaorg/animica-mcp) | Animica 后量子区块链只读数据（链头、区块、交易、余额、富豪榜）、免费 OpenAI 兼容 AI 推理、量子随机数信标与矿池统计，16 个工具，不持有私钥。 | 官方实现 (Animica) 🎖️, Python 开发 🐍, 云端/本地 🏠☁️, 跨平台 🍎🪟🐧, `uvx animica-mcp` 或远程 https://mcp.animica.org/mcp |
