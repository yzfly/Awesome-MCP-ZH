...
| [YouTube Transcript + YouTube Search MCP](https://github.com/tubeagentkit/youtube-mcp) | 远程 MCP 服务，获取 YouTube 视频字幕/转录文本，并支持视频与频道搜索、频道最新视频、频道视频浏览、播放列表提取，共 6 个工具。 | 官方实现 (getyoutubetranscript.com) 🎖️, 云服务 ☁️, 远程端点 `https://getyoutubetranscript.com/api/mcp` (Streamable HTTP), 支持 OAuth 2.1 与 API Key, 免费额度, 无需信用卡。 |
