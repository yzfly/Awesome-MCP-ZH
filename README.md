...
| [friendlygeorge/docker-mcp-server](https://github.com/friendlygeorge/docker-mcp-server) | Docker 容器管理 MCP 服务器，提供 50+ 工具用于容器生命周期管理、Compose 编排、健康检查、日志流和系统监控。 | 社区实现, TypeScript 开发 📇, 本地运行 🏠, Docker 容器管理 (50+ 工具)。                                    |
