...
| [Superhighway](https://github.com/patwalls/superhighway-mcp)         | AI 代理专用网络搜索 API，提供搜索、新闻、图片、抓取和深度研究五种工具；支持 x402 协议的 USDC 自主付款（每次调用 $0.001），或免费 API 密钥。 | 官方实现 (Superhighway) 🎖️, TypeScript 开发 📇, 云服务 ☁️, x402 自主付款 + 五种搜索工具。 |
