...
| [AMEOBIUS/mcp-git-manager](https://github.com/AMEOBIUS/mcp-git-manager) | MCP 服务器，用于 git 操作。24 个工具：状态、日志、差异、分支（创建/切换/删除）、提交、推送、拉取、标签、暂存、远程管理。零依赖，纯 Python subprocess。 |
