...
| [AMEOBIUS/mcp-cdp-scraper](https://github.com/AMEOBIUS/mcp-cdp-scraper) | MCP 服务器，通过 Chrome DevTools 协议进行 AI 代理网页抓取。12 个工具（抓取页面、提取文本/链接/图片/表格、填写表单、点击、截图等）。零依赖，纯 Python 标准库，无需 Playwright/Selenium。支持 React/Vue 表单填写。 |
