...
| [ZengLiangYi/ChatCrystal](https://github.com/ZengLiangYi/ChatCrystal) | AI 对话知识提炼工具，从 Claude Code、Cursor、Codex CLI、Trae、Copilot 导入对话，生成结构化笔记并支持语义搜索。 | 社区实现, TypeScript 开发 📇, 本地运行 🏠, 5 数据源适配器 + MCP Server |
