...
| [SandBase CLI](https://github.com/sandbaseai/cli)                              | 通过一个 MCP 桥接器将 AI 编程 Agent 连接到 2,000+ AI 模型与多类工具，覆盖搜索、社交媒体、网页抓取、多模态生成与云端沙箱。 | 官方实现 (SandBase) 🎖️, TypeScript 开发 📇, 云端/本地 🏠☁️, Apache-2.0, `npx -y @sandbaseai/cli connect`。 |
