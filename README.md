...
| [offendersearch/mcp](https://github.com/offendersearch/mcp) | 一次查询全美 58 个性犯罪者登记库（覆盖所有州、华盛顿特区及各领地），支持按姓名、出生日期、城市、地址或地理半径搜索，返回带评分的匹配结果及官方登记记录链接。 | 社区实现, Python 开发 🐍, 本地/远程 🏠☁️, 需 API key（25 次免费），后端 offendersearch.app。 |
