...
| [TradeRouter/trade-router-mcp](https://github.com/TradeRouter/trade-router-mcp)    | Solana 非托管交换与限价订单 MCP 服务器，21 个工具 (swap, limit, trailing, TWAP, DCA, 组合订单)，路由 Raydium/PumpSwap/Orca/Meteora。Jito MEV 防护，Ed25519 验证服务器消息。Non-custodial Solana swap & limit-order MCP server, 21 tools across multi-DEX, Jito MEV-protected. | 官方实现 (Trade Router) 🎖️, JavaScript 开发 📇, 云服务 ☁️, Solana 多 DEX 路由 + 订单管理。 |
