...
| [AMEOBIUS/mcp-http-tester](https://github.com/AMEOBIUS/mcp-http-tester) | MCP 服务器，用于 REST API 测试。9 个工具：GET/POST/PUT/PATCH/DELETE/HEAD、批量请求、URL 健康检查。支持 JSON/表单数据、Basic Auth。零依赖，纯 Python 标准库。 |
