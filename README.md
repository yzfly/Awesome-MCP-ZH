...
| [AMEOBIUS/mcp-encode-tools](https://github.com/AMEOBIUS/mcp-encode-tools) | MCP 服务器，用于编码操作。22 个工具：base64/URL/HTML/hex/binary 编解码、摩尔斯电码、ROT13、凯撒密码、Atbash、字符串反转、JWT 解码。零依赖，纯 Python 标准库。 |
