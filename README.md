...
| [ajtgjmdjp/estat-mcp](https://github.com/ajtgjmdjp/estat-mcp) | 日本政府统计门户 [e-Stat](https://www.e-stat.go.jp/) 的 MCP 服务器。可搜索和获取人口、GDP、CPI、劳动、贸易等 3,000+ 统计表，支持自动分页和 Polars DataFrame 导出。 | 社区实现, Python 开发 🐍, 云服务 ☁️, 本地运行 🏠, 日本政府统计数据。 |
