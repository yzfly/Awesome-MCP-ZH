...
| [AMEOBIUS/mcp-seo-tools](https://github.com/AMEOBIUS/mcp-seo-tools) | MCP 服务器，用于 SEO 工具。14 个工具：meta 标签、OpenGraph、Twitter Cards、XML 站点地图、robots.txt、关键词密度、slug、canonical、Schema.org、URL 分析、hreflang、alt 文本、标题层级检查。零依赖，纯 Python 标准库。 |
