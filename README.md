...
| [AMEOBIUS/mcp-validation-tools](https://github.com/AMEOBIUS/mcp-validation-tools) | MCP 服务器，用于数据验证。13 个工具：邮箱、URL、IP、UUID、电话、日期、信用卡（Luhn）、JSON、正则表达式、Schema、批量验证、密码强度、邮政编码。零依赖，纯 Python 标准库。 |
