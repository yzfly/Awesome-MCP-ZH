...
| [gemini-embedding-2-mcp-server](https://github.com/AlaeddineMessadi/gemini-embedding-2-mcp-server) | 使用 Gemini Embedding 2 的 MCP 服务器，将任何本地目录转换为极速、具备视觉感知的空间搜索引擎，专为 AI 代理设计。 | 社区实现, Python 开发 🐍, 本地运行 🏠, 多模态跨格式 (文件/图片) RAG 搜索引擎。                           |
