...
| [Hive Intelligence](https://github.com/hive-intel/hive-sdk)                        | 面向 AI 代理的托管加密情报 MCP，覆盖市场数据、DeFi、钱包、安全风险、DEX 流、NFT、Solana 和预测市场等工作流。 | 官方实现 (Hive Intelligence) 🎖️, TypeScript SDK, 云端/本地 🏠☁️, 加密情报与多提供商数据。                 |
