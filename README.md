...
| 名称                                                                               | 中文介绍                                                                                                     | 备注                                                                                                       |
| :--------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------- |
| [tinqiao-oss/clawtouch-mcp](https://github.com/tinqiao-oss/clawtouch-mcp) | 把真实 USB HID 键鼠硬件（Raspberry Pi Pico 2 跑开源固件）暴露为 MCP 工具：移动 / 点击 / 拖拽 / 输入 / 组合键 / 滚轮。任意 MCP 客户端（Claude Desktop / Cursor / Cline 等）可接；内置 --mock 模式无硬件可试。 | 社区实现, Python 开发 🐍, 本地运行 🏠, 跨平台 🍎🪟🐧, MIT, `pip install clawtouch-mcp`。 |
